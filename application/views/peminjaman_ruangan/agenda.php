...
<div class="modal fade" id="tambah_agenda" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Agenda Baru</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <form class="form" action="<?= base_url('peminjaman_ruangan/agenda/tambah_agenda') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tanggal" id="Tanggal" placeholder="Tanggal" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="Waktu_Mulai">Waktu Mulai Agenda</label>
                                <input type="time" class="form-control" name="waktu_mulai" id="Waktu_Mulai" placeholder="Waktu_Mulai" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="Waktu_Akhir">Waktu Akhir Agenda</label>
                                <input type="time" class="form-control" name="waktu_akhir" id="Waktu_Akhir" placeholder="Waktu_Akhir" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="isi pengumuman">Deskripsi</label>
                        <div class="input-group">
                            <textarea class="form-control" id="isi pengumuman" name="isi" rows="4"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Kembali</button>
                    <button type="submit" class="btn btn-primary font-weight-bold" id="submit_tambah_file">Simpan</button>
                </div>
            </form>
        </div>
    </div>
