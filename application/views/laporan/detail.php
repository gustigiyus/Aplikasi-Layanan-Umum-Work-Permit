              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="card card-custom card-stretch">
                    <div class="card-header">
                      <div class="card-title">
                        <h4 class="card-label" style="text-align: center;">Pengaju Complain
                        </h4>
                      </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="card card-custom">
                    <div class="card-header">
                      <div class="card-title">
                        <h4 class="card-label" style="text-align: center;">Detail Complain
                        </h4>
                      </div>
                    </div>
                    <div class="card-body">
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="card card-custom card-stretch">
                    <div class="card-header">
                      <div class="card-title">
                        <h4 class="card-label" style="text-align: center;">Deskripsi Complain
                        </h4>
                      </div>
                    </div>
                    <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card card-custom">
                    <div class="card-header">
                      <div class="card-title">
                        <h4 class="card-label" style="text-align: center;">Foto Complain
                        </h4>
                      </div>
                    </div>
                    <div class="card-body">
