        ...
        <div class="card-header bg-white py-3">
            <div class="row">
                ...
                <div class="col-auto">
                    ...
                    <a href="" class="btn btn-primary btn-icon-split mb-3" data-toggle="modal" data-target="#newRuanganModal">
                    ...
                    <div class="form-group">
                        ...
                        <?php foreach ($perlengkapan_ruangan as $plkp_rng) : ?>
                            <div class="custom-control custom-checkbox small">
                                <input type="checkbox" class="custom-control-input" name="perlengkapan[]" value="<?= $plkp_rng['perlengkapan_ruangan'] ?>" id="customCheck-<?= $plkp_rng['id_perlengkapan_ruangan'] ?>">
                                <label class="custom-control-label" for="customCheck-<?= $plkp_rng['id_perlengkapan_ruangan'] ?>">
...
<?php foreach ($ruangan as $r) : ?>
    ...
    <div class="modal fade" id="hapususer<?PHP echo $r['id_master_ruangan']; ?>" tabindex="-1" role="dialog" aria-labelledby="newRuanganModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newRuanganModalLabel">Hapus Data Ruangan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?= base_url('admin/delete_ruangan/') . $r['id_master_ruangan']; ?>" method="post">
                    <div class="modal-body">
                        <h6 class="text" style="font-weight: bolder;">Anda Yakin Untuk Hapus Ruangan <strong class="text text-danger"><?php echo $r['tipe_ruangan']; ?></strong> ?</h6>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
