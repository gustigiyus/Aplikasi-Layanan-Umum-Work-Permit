                    ...
                    <tr>
                        ...
                        <td class="align-middle" style="text-align: center;">
                            <a class="btn btn-warning btn-sm btn-icon mb-1" data-toggle="modal"
                                data-target="#edituser<?PHP echo $urs['id']; ?>">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a class="btn btn-danger btn-sm btn-icon" data-toggle="modal"
                                data-target="#hapususer<?PHP echo $urs['id']; ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="email" id="email"
                            placeholder="Masukan email karyawan" required autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="password2" id="password2"
                            placeholder="Masukan kata sandi konfirmasi" required autocomplete="off">
                    </div>
                </div>
...
<div class="modal fade" id="edituser<?PHP echo $usr['id']; ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/edituser'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="email" id="email2" placeholder="Masukan email"
                            value="<?= $usr['email']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="password1" id="password11"
...
<div class="modal fade" id="hapususer<?PHP echo $usr['id']; ?>" tabindex="-1" role="dialog"
    aria-labelledby="newRoleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
