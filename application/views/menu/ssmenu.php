                    ...
                    <tr>
                        ...
                        <td class="align-middle" style="text-align: center;">
                            <a class="btn btn-warning btn-sm btn-icon" data-toggle="modal"
                                data-target="#editssmenu<?PHP echo $ssm['id']; ?>">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a class="btn btn-danger btn-sm btn-icon" data-toggle="modal"
                                data-target="#delssmenu<?PHP echo $ssm['id']; ?>">
...
<div class="modal fade" id="editssmenu<?PHP echo $ssubmen['id']; ?>" tabindex="-1" role="dialog"
...
<div class="modal fade" id="delssmenu<?PHP echo $ssubmen['id']; ?>" tabindex="-1" role="dialog"
    aria-labelledby="newRoleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
