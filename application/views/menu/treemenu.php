...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newSubMenuModal">Tambah Tree Menu Baru</a>
                    ...
                    <?php foreach ($treeMenu as $trmenu) : ?>
                        <tr>
                            ...
                            <td class="align-middle" style="text-align: center;">
                                <a class="btn btn-warning btn-sm btn-icon" data-toggle="modal" data-target="#edittreemenu<?PHP echo $trmenu['id']; ?>">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a class="btn btn-danger btn-sm btn-icon" data-toggle="modal" data-target="#deltreemenu<?PHP echo $trmenu['id']; ?>">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/treemenu'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="icon" id="icon" value="menu-bullet menu-bullet-dot" placeholder="Icon Submenu" required readonly>
                    </div>
                    <div class="form-group">
...
<?php foreach ($treeMenu as $treemenu) : ?>
    <div class="modal fade" id="edittreemenu<?PHP echo $treemenu['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('menu/edittreemenu/') . $treemenu['id']; ?>" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="Masukan nama" value="<?= $treemenu['title']; ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="url" id="url" placeholder="Masukan nama" value="<?= $treemenu['url']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="icon"> Icon : </label>
                            <input type="text" class="form-control" name="icon" id="icon" placeholder="Masukan nama" value="<?= $treemenu['icon']; ?>" required>
                        </div>
    ...
    <div class="modal fade" id="deltreemenu<?PHP echo $treemenu['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('menu/deltreemenu/') . $treemenu['id']; ?>" method="post">
                    <div class="modal-body">
                        <h5 class="text text-danger">Anda Yakin Untuk Hapus Tree Menu <?php echo $treemenu['title']; ?> ?</h5>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
