                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td class="align-middle" style="text-align: center;">
                                <a class="btn btn-warning btn-sm btn-icon" data-toggle="modal" data-target="#editsubmenu<?PHP echo $sm['id']; ?>">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a class="btn btn-danger btn-sm btn-icon" data-toggle="modal" data-target="#hapussubmenu<?PHP echo $sm['id']; ?>">
...
<?php foreach ($subMenu as $submen) : ?>
    <div class="modal fade" id="editsubmenu<?PHP echo $submen['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('menu/editsubmenu/') . $submen['id']; ?>" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="Masukan nama" value="<?= $submen['title']; ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="url" id="url" placeholder="Masukan nama" value="<?= $submen['url']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="icon"> Icon : </label>
                            <input type="text" class="form-control" name="icon" id="icon" placeholder="Masukan nama" value="<?= $submen['icon']; ?>" required>
                        </div>
    ...
    <div class="modal fade" id="hapussubmenu<?PHP echo $submen['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
