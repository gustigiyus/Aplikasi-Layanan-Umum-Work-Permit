        ...
        <div class="card-header bg-white py-3">
            <div class="row">
                ...
                <div class="col-auto">
                    ...
                    <a href="" class="btn btn-primary btn-icon-split mb-3" data-toggle="modal" data-target="#myModal">
                    ...
                    <tr>
                        ...
                        <td class="align-middle" style="text-align: center;">
                            <a class="btn btn-warning btn-sm btn-icon" data-toggle="modal"
                                data-target="#editmenu<?PHP echo $m['id']; ?>">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a class="btn btn-danger btn-sm btn-icon" data-toggle="modal"
                                data-target="#hapusmenu<?PHP echo $m['id']; ?>">
...
<div class="modal fade" id="editmenu<?PHP echo $men['id']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/editmenu/') . $men['id']; ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="menu" id="menu" placeholder="Masukan nama"
                            value="<?= $men['menu']; ?>" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
...
<div class="modal fade" id="hapusmenu<?PHP echo $men['id']; ?>" tabindex="-1" role="dialog"
    aria-labelledby="newRoleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
