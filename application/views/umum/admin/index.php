                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <?php if ($this->session->userdata('role_id') == 3) : ?>
                                                ...
                                                <?php else : ?>
                                                    <a href="" class="btn btn-primary disabled" data-toggle="modal" data-target="#myModaleditStatus<?PHP echo $comp['id']; ?>"><?= $comp['status_complain']; ?></a>
                                                <?php endif; ?>
...
<?php foreach ($complain as $comp) : ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModaleditStatusLabel">Ubah Status Complain</h5>
                ...
                <form action="<?= base_url('permintaan/editStatusComplain'); ?>" method="post">
                    <div class="modal-body">
                        <div class="row justify-content-around">
                            <a href="" class="btn btn-primary col-md-5 mt-2" data-toggle="modal" data-target="#myModalView<?PHP echo $comp['id']; ?>">Detail Complain</a>
                        ...
                        <div class="form-group mt-2">
                            <select class="form-control" name="status_complain" id="status_complain">
                                <?php if ($comp['status_complain'] == "Pending") : ?>
                                    ...
                                    <option value="Complain Disetujui">Complain Disetujui</option>
                                <?php elseif ($comp['status_complain'] == "Meminta Izin Kerja") : ?>
                                    <option value="<?= $comp['status_complain']; ?>"><?= $comp['status_complain']; ?></option>
    ...
    <div class="modal fade" id="myModalView<?PHP echo $comp['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalViewLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalViewLabel">Detail Complain</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="" method="post">
                    <div class="modal-body">
                        ...
                        <label class="control-label font-weight-bold" style="display: block; height:50px; line-height:50px; text-align:center; font-size:20px;"> Gambar Complain</label>
