            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Perseetujuan Permintaan</a>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Ubah Persetujuan</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-body p-0">
                                    ...
                                    <div class="d-flex justify-content-between text-white pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-root">
                                            ...
                                            <?php elseif ($dt_prmt_lyn['status_permintaan'] == 'Menunggu TTD') : ?>
                                                <span class=""><span class="label label-info label-inline mr-2"><?= $dt_prmt_lyn['status_permintaan']; ?></span></span>
                                            <?php elseif ($dt_prmt_lyn['status_permintaan'] == 'Sedang Diproses') : ?>
                                                <span class=""><span class="label label-success label-inline mr-2"><?= $dt_prmt_lyn['status_permintaan']; ?></span></span>
                                            <?php else : ?>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="kt_tab_pane_data_pengaju" role="tabpanel" aria-labelledby="kt_tab_pane_data_pengaju">
                                                    <h3 class="font-weight-bolder font-size-h2 mb-9">
                                                        <span class="text-dark-75">Data Penginput</span>
                                                    </h3>
                                                    <?php foreach ($data_user as $dt_usr) : ?>
                                                        <!--begin::Info-->
                                                ...
                                                <div class="tab-pane fade" id="kt_tab_pane_data_permintaan" role="tabpanel" aria-labelledby="kt_tab_pane_data_permintaan">
                                                    <h3 class="font-weight-bolder font-size-h2 mb-9">
                                                        <span class="text-dark-75">Data Permintaan</span>
                                                    </h3>
                                                    <!--begin::Info-->
                                                    <div class="d-flex mb-3">
                                                ...
                                                <div class="tab-pane fade" id="kt_tab_pane_data_pekerjaan" role="tabpanel" aria-labelledby="kt_tab_pane_data_pekerjaan">
                                                    <h3 class="font-weight-bolder font-size-h2 mb-9">
                                                        <span class="text-dark-75">Data Distribusi Pekerja</span>
                                                    </h3>
                                                ...
                                                <div class="tab-pane fade" id="kt_tab_pane_data_pemeriksaan" role="tabpanel" aria-labelledby="kt_tab_pane_data_pemeriksaan">
                                                    <h3 class="font-weight-bolder font-size-h2 mb-1">
                                                        <span class="text-dark-75">Data Pemeriksaan</span>
                                                    </h3>
                                                ...
                                                <div class="tab-pane fade" id="kt_tab_pane_data_penyerahaan" role="tabpanel" aria-labelledby="kt_tab_pane_data_penyerahaan">
                                                    <h3 class="font-weight-bolder font-size-h2 mb-1">
                                                        <span class="text-dark-75">Data Penyerahaan</span>
                                                    </h3>
                                                    <!--begin::Info-->
                                                    <div class="col-lg-12 border-bottom border-black py-8 mb-6">
                                                        <div class="row">
                            ...
                            <div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
                                <div class="col-md-9">
                                        ...
                                        <div class="d-flex flex-column flex-root">
                                            ...
                                            <?php foreach ($detail_user as $dt_usr) : ?>
                                                <div class="d-flex mb-4">
                                                    <span class="text-dark-50 flex-root font-weight-bold">Nama :</span>
                                                    <span class="text-dark flex-root font-weight-boldest"><?= $dt_usr['nama']; ?></span>
                                                </div>
                                                <div class="d-flex mb-4">
                                    ...
                                    <div class="col-md-12 pt-8" style="border-top: 1px solid black;">
                                        <form method="POST" id="form_close_permintan">
                                            <!-- Data Parammeter STATUS yang dikirm ke database -->
                                            <div class="form-group" hidden>
                                                <label for="no_permintaan" style="color: black; float: left;">Status Permintaan</label>
                                                <input type="text" class="form-control" name="no_permintaan" value="<?= $dt_prmt_lyn['no_permintaan']; ?>" required>
                                            </div>
                                            <div class="form-group" hidden>
                                                <label for="status_permintaan" style="color: black; float: left;">Status Permintaan</label>
                                                <input type="text" class="form-control" name="status_permintaan" value="Close" required>
                                            </div>
                                            <?php if ($dt_pmrsk['ttd_penerima_layanan'] and $dt_pmrsk['ttd_pemeriksaan'] != "") : ?>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12" style="text-align: center;">
                                                        <button type="submit" class="btn btn-light-primary btn-lg font-weight-boldest">
                                            ...
                                            <?php else : ?>
                                                <div class="col-md-12 col-sm-12">
                                                    <a data-toggle="tooltip" data-theme="dark" title="Permintaan tidak dapat di Tutup karena masih ada data yang belum di tanda tangani oleh Pengaju atau Atasan" class="btn btn-light-danger font-weight-boldest" style="float: right; cursor: not-allowed;">
                                                        <i class="fas fa-check"></i>
                                                        Tutup Permintaan
                                                    </a>
                                                </div>
