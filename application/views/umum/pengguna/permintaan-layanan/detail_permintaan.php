        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    <!--begin::Title-->
                    <h2 class="text-white font-weight-bold my-2 mr-5">Detail Permintaan Layanan</h2>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Data Permintaan Layanan</a>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Detail Permintaan</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom overflow-hidden">
                        <div class="card-body p-0">
                                    ...
                                    <div class="d-flex justify-content-between text-white pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-root">
                                            ...
                                            <?php elseif ($dt_prmt_lyn['status_permintaan'] == 'Menunggu TTD') : ?>
                                                <span class=""><span class="label label-danger label-pill label-inline mr-2"><?= $dt_prmt_lyn['status_permintaan']; ?></span></span>
                                            <?php elseif ($dt_prmt_lyn['status_permintaan'] == 'Sedang Diproses') : ?>
                                                <span class=""><span class="label label-success label-pill label-inline mr-2"><?= $dt_prmt_lyn['status_permintaan']; ?></span></span>
                                            <?php else : ?>
                            ...
                            <div class="row justify-content-center bg-white-100 py-8 px-8 py-md-10 px-md-0">
                                <div <?php if ($dt_prmt_lyn['status_permintaan'] == 'Open') {
                                            echo 'class="col-md-8"';
                                        } else {
                                ...
                                <div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
                                    <div class="col-md-9">
                                        <div class="d-flex flex-column flex-md-row font-size-lg">
                                            <div class="d-flex flex-column flex-root">
                                                <div class="font-weight-bolder mb-10" style="font-size: 20px; text-align: center;">DATA ATASAN</div>
                                                ...
                                                <div class="d-flex mb-lg-15 mb-md-15 mb-sm-15">
                                            ...
                                            <div class="d-flex flex-column flex-md-row">
                                                <!--begin::Form-->
                                                <?php if ($dt_pmrsk['ttd_penerima_layanan'] == "") : ?>
                                                    <div style="text-align: center;" class="form-group col-md-12">
                                                        ...
                                                        <!--Bagian::Form Upload TTD Penyerhaan-->
                                                        <div class="dropzone mb-3" id="file_upload_ttd_penerima_layanan">
                                                            <div class="dz-message">
                                                                <h5>Letakkan Tanda Tangan di sini</h5> Atau <strong>klik</strong> untuk mengunggah
                                                            </div>
                                                        </div>
                                                        <button type="button" id="upload_ttd_penerima_layanan" class="btn btn-info"><i class="fas fa-cloud-upload-alt"></i> Unggah TTD</button>
                            ...
                            <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
                                <div class="col-md-9">
                                    <div class="d-flex justify-content-center">
                                        <a href="<?= base_url('permintaan_layanan/properti'); ?>" class="btn btn-primary font-weight-bold">
                                            <i class="fa fa-home"></i>
                                            Kembali ke halaman Permintaan Layanan
                                        </a>
                                    </div>
                                </div>
                            </div>
