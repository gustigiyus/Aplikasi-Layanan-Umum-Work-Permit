            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Laporan Permintaan Layanan</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    <div class="card-title">
                        ...
                        <h3 class="card-label"> Tabel Laporan Permintaan Layanan</h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin: Datatable-->
                    <div class="table-responsive">
                        <table class="table table-separate table-head-custom" id="tabel_data_permintaan_layanan_karyawan">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($layananbaru as $lb) : ?>
                                    <tr>
                                        ...
                                        <td class="align-middle" style="text-align: center;">
                                            <a data-toggle="tooltip" data-theme="dark" data-placement="left" title="Lihat Detail Permintaan" href="<?= base_url('permintaan_layanan/laporan/detail_laporan_pengguna/') . $lb['no_permintaan']; ?>" target="_blank" class="btn btn-icon btn-light-primary btn-hover-primary btn-sm mb-md-3">
