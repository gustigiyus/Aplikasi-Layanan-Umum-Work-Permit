    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                ...
                <div class="alert-text">Pada Halaman ini anda dapat melihat dan melakukan Peminjaman Ruangan yang tersedia di <b>PT INTI</b>.
                </div>
            </div>
            <!--end::Notice-->
                    ...
                    <?php if ($this->session->userdata('role_id') == 2 || $this->session->userdata('role_id') == 4) : ?>
                        <div class="card-toolbar">
                            ...
                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                ...
                                <a href="#" style="border-bottom-right-radius: 7px; border-top-right-radius: 7px;" class="btn btn-primary btn-md font-weight-boldest btn-square" data-toggle="modal" data-target="#addpinjaman">Booking Ruangan</a>
                                ...
                                <?php foreach ($data_peminjaman as $pjm) : ?>
                                    <tr>
                                                ...
                                                <td class="align-middle" style="text-align: center;">
                                                    <div class="d-flex flex-column w-100 mr-2">
                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                            ...
                                                            <span data-toggle="tooltip" data-theme="dark" data-placement="left" title="Status Peminjaman Ruangan telah dibuka" class="badge badge-primary">Pending</span>
                                                        </div>
                                        ...
                                        <td class="align-middle" style="text-align: center;">
                                            ...
                                            <?php if ($this->session->userdata('role_id') == 2 || $this->session->userdata('role_id') == 4) : ?>
                                                <?php if ($pjm['status_peminjaman'] == "Open") : ?>
                                                    <a href="<?= base_url('peminjaman_ruangan/Peminjaman/editpeminjaman/' . $pjm['no_peminjaman']); ?>" title="Edit"><i style="color: orange;" class="fas fa-pencil-alt"></i></a>
                                                <?php elseif ($pjm['status_peminjaman'] == 'Close') : ?>
                                                    <a data-toggle="tooltip" data-theme="dark" data-placement="left" title="Lihat Detail Peminjaman" href="<?= base_url('peminjaman_ruangan/laporan/detail_laporan/') . $pjm['no_peminjaman']; ?>" target="_blank" class="btn btn-icon btn-light btn-hover-primary btn-sm x">
...
<div class="modal fade" id="addpinjaman" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="AddPinjamanRuangandataLabel">
            ...
            <form action="<?= base_url('peminjaman_ruangan/Peminjaman/addpeminjaman'); ?>" method="POST" id="kt_add_peminjaman_ruangan_form">
                <div class="scroll scroll-pull" data-scroll="true" data-height="450">
                    <div class="modal-body">
                        <div>
                            <h5 class="font-weight-boldest mb-6">DATA USER</h5>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="nama_peminjaman" style="color: black; float: left;">Nama Lengkap</label>
                                <input type="text" class="form-control form-control-solid" name="nama_peminjaman" value="<?= $detail_user[0]['nama']; ?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="email_peminjaman" style="color: black; float: left;">Email</label>
                                <input type="email" class="form-control form-control-solid" name="email_peminjaman" value="<?= $detail_user[0]['email']; ?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="nip" class="form-control-label" style="color: black; float: left;">NIP</label>
                                <input autoborrlete="off" type="text" class="form-control form-control-solid" name="nip" value="<?= $detail_user[0]['nip']; ?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label id="ext/hp" class="form-control-label" style="color: black; float: left;">EXT/HP</label>
                                <input autoborrlete="off" type="text" class="form-control form-control-solid" name="ext/hp" value="<?= $detail_user[0]['nomer_telepon']; ?>" readonly>
                            </div>
                            <div class="form-group col-md-12">
                                <label id="divisi" class="form-control-label" style="color: black; float: left;">Divisi</label>
                                <input autoborrlete="off" type="text" class="form-control form-control-solid" name="divisi" value="<?= $detail_user[0]['divisi']; ?>" readonly>
                            </div>
                        </div>
                        <div class="separator separator-dashed my-5"></div>
                        <div>
                            <h5 class="font-weight-boldest mb-6">DATA PEMINJAMAN</h5>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label text-right col-lg-3 col-sm-12">Perlengkapan Ruangan</label>
