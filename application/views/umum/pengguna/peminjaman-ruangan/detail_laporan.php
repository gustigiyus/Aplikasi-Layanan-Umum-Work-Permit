                                    ...
                                    <div class="d-flex justify-content-between text-white pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-root">
                                            ...
                                            <?php if ($pjm['status_peminjaman'] == 'Open') : ?>
                                                <span class=""><span class="label label-primary label-inline mr-2">Pending</span></span>
                                            <?php else : ?>
                                                <span class=""><span class="label label-dark label-pill label-inline mr-2">Selesai</span></span>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <thead>
                                                                <tr class="bg-gray-100 text-left">
                                                                    <th style="min-width: 200px" class="pl-7">
                                                                        <span class="text-dark-75">Tanggal Permintaan</span>
                                                                    </th>
                                    ...
                                    <div class="d-flex flex-column flex-md-row font-size-lg">
                                        <div class="d-flex flex-column flex-root">
                                            ...
                                            <div class="d-flex mb-lg-15 mb-md-15 mb-sm-10">
                                                <span class="text-dark-50 flex-root font-weight-bold">No. Atasan :</span>
                                                <span class="text-dark flex-root font-weight-bold"><?= $pjm['nomor_atasan']; ?></span>
                                            </div>
                                            <div class="d-flex mb-sm-8">
                                                <span class="text-dark-50 flex-root font-weight-bold">Status :</span>
                                                <?php if ($pjm['status_peminjaman'] == 'Open') : ?>
                                                    <span class="text-dark-50 flex-root font-weight-bold"><span class="label label-primary label-inline">Pending</span></span>
                                                <?php else : ?>
                                                    <span class="text-dark-50 flex-root font-weight-bold"><span class="label label-dark label-pill label-inline">Selesai</span></span>
                                                <?php endif ?>
                                            </div>
                                        </div>
                                            ...
                                            <div style="text-align: center;" class="form-group col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div style="width: 250px; height: 250x; margin-left: auto; margin-right: auto;">
                                                        <img src="<?= base_url('assets/img/peminjaman_ruangan/' . $pjm['ttd_peminjaman_ruangan']) ?>" class="img-thumbnail">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
